...
weights_name = "inria-PGDNet"       
weights_path = "/root/autodl-tmp/log/inria/{}".format(weights_name)
test_weights_name = "inria-PGDNet"
log_name = "/root/PGDNet/log/inria/{}".format(weights_name)
