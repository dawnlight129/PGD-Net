...
from geoseg.datasets.mass_bie import *
...
weights_name = "mass-new-vmamba-bie"
weights_path = "/root/EB-TDFNet/log/mass/{}".format(weights_name)
test_weights_name = "mass-new-vmamba-bie-v5"
...
resume_ckpt_path = '/root/EB-TDFNet/log/mass/mass-new-vmamba-bie/last.ckpt'
...
#     net.load_from()
# net = TDFNet()
from geoseg.models.combine_cm_bie import combine_cm
net = combine_cm()
