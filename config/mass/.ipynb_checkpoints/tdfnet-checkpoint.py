...
weights_name = "mass-new-mambaVision-resnet50"
weights_path = "/root/EB-TDFNet/log/mass/{}".format(weights_name)
test_weights_name = "mass-new-mambaVision-resnet50"
...
# resume_ckpt_path = '/root/EB-TDFNet/log/mass/mass-new-vmamba-sdi2/mass-new-vmamba-sdi2-v1.ckpt'
...
#     net.load_from()
# net = TDFNet()
from geoseg.models.combine_cm_pretraining import combine_cm
net = combine_cm()
