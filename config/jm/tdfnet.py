...
weights_name = "jm-new-pvtv2-vgg19-96"
weights_path = "/root/EB-TDFNet/log/jm/{}".format(weights_name)
test_weights_name = "jm-new-pvtv2-vgg19-96-v2"
log_name = "/root/EB-TDFNet/log/jm/{}".format(weights_name)
monitor = 'val_mIoU'
monitor_mode = 'max'
save_top_k = 3
save_last = True
...
# from geoseg.models.PVTV2 import TDFNet
...
#     net.load_from()
# net = TDFNet()
from geoseg.models.combine_cm import combine_cm
net = combine_cm()
