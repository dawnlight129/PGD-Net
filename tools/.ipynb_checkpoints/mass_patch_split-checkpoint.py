...
def parse_args():
    ...
    parser.add_argument("--input-img-dir", default="/root/autodl-tmp/Mass_512/train/img")
    parser.add_argument("--input-mask-dir", default="/root/autodl-tmp/Mass_512/train/mask")
