...
class combine_cm(nn.Module):
    def __init__(self, 
        ...
        # pvt-v2
        # self.Translayer_1 = BasicConv2d(64, 1*mid_channel, 1,stride=1)         
        # self.Translayer_2 = BasicConv2d(128, 2*mid_channel, 1,stride=1)
        # self.Translayer_3 = BasicConv2d(320, 4*mid_channel, 1,stride=1)         
        # self.Translayer_4 = BasicConv2d(512, 8*mid_channel, 1,stride=1)  
        ...
        # # vgg19
        # self.Translayer_5 = BasicConv2d(128, 1*mid_channel, 1,stride=1)
        # self.Translayer_6 = BasicConv2d(256, 2*mid_channel, 1,stride=1)
        # self.Translayer_7 = BasicConv2d(512, 4*mid_channel, 1,stride=1)
        # self.Translayer_8 = BasicConv2d(512, 8*mid_channel, 1,stride=1)  
        ...
        # self.inc = vgg19_bn.features[:7]  # 64
        # self.down1 = vgg19_bn.features[7:14]  # 64
        # self.down2 = vgg19_bn.features[14:27]  # 128
        # self.down3 = vgg19_bn.features[27:40]  # 256
        # self.down4 = vgg19_bn.features[40:]  # 512
