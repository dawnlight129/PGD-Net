...
class Decoder(nn.Module):
    ...
    def forward(self, x, res1, res2, res3, res4, h, w):
        ...
        # AFEB2
        out_dec_level3 = self.EGA2(inp_dec_level3)
        ...
        # AFEB3
        out_dec_level2 = self.EGA3(inp_dec_level2)
...
if __name__ == '__main__':
    ...
    model = AFENet(decode_channels=96, num_classes=2, pretrained=True).cuda()
    output = model(input)
