...
try:
    from .lib.ss2d import SS2D
    from .lib.csms6s_gm import CrossScan_1, CrossScan_2, CrossScan_3, CrossScan_4
    from .lib.csms6s_gm import CrossMerge_1, CrossMerge_2, CrossMerge_3, CrossMerge_4
except:
    from lib.ss2d import SS2D
    from lib.csms6s_gm import CrossScan_1, CrossScan_2, CrossScan_3, CrossScan_4
    from lib.csms6s_gm import CrossMerge_1, CrossMerge_2, CrossMerge_3, CrossMerge_4
...
if __name__ == "__main__":
    ...
    # tiny:   FLOPs:  24.381G   Params:  22.372M
    # small:  FLOPs:  37.772G   Params:  33.614M
    # base:   FLOPs:  73.633G   Params:  55.899M
