...
try:
    from .csms6s_gm import CrossScan, CrossMerge
    from .csms6s_gm import SelectiveScanMamba, SelectiveScanCore, SelectiveScanOflex
except:
    from lib.csms6s_gm import CrossScan, CrossMerge
    from lib.csms6s_gm import SelectiveScanMamba, SelectiveScanCore, SelectiveScanOflex
